    ...
    const HandleEdit = async (dataValue,id) => {
        try {
          console.log(dataValue ,id)
            const Student=await axios.put(`http://localhost:4000/api/v1/Admin/EditStudent/${id}`,{
              NAME:dataValue.NAME,
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
          ...
          <DialogContent className="sm:max-w-[550px] sm:max-h-[97%]">
            ...
            <form onSubmit={handleSubmit((value) => {HandleEdit(value,data.STUDENT_ID);console.log(data)})}>
